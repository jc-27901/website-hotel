...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>HOTEL NEXUS,</p>
				<p>ABC Road,<br>Andaman Nicobar Island,<br>India</p>
				<p>+91 0281-XXXX</p>
			</address>
		</header>
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix>₹</span><span><?php echo $ttot*10; ?></span></td>
					</tr>
					<tr>
						...
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix>₹</span><span><?php echo $btot*10; ?></span></td>
					</tr>
					<tr>
						...
						<td><span ><?php echo $nroom;?> </span></td>
						<td><span data-prefix>₹</span><span><?php echo $mepr*10; ?></span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>₹</span><span><?php echo $fintot*10; ?></span></td>
				</tr>
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@hotelnewxus.com || Web :- www.hotelnexus.com || Phone :- +91 0281-XXXX </p>
			</div>
		</aside>
	</body>
</html>
